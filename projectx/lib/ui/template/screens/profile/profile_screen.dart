              ...
              children: [
                Positioned(
                  child: Image.network(
                    ...
                    loadingBuilder: (context, child, loadingProgress) => ImageLoaderWidget(height: height * 0.3, width: width, child: child, loadingProgress: loadingProgress),
                    height: height * 0.3,
                    width: width,
                ...
                Positioned(
                  child: Image.network(
                    ...
                    loadingBuilder: (context, child, loadingProgress) => ImageLoaderWidget(height: width * 0.2, width: width * 0.2, child: child, loadingProgress: loadingProgress),
                    height: width * 0.2,
                    fit: BoxFit.cover,
                    width: width * 0.2,
