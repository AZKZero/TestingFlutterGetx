...
import 'package:projectx/ui/template/components/grid/foundation/extensions.dart';
...
class _SliverQuiltedGridLayout extends SliverGridLayout {
  ...
  double computeMaxScrollOffset(int childCount) {
    ...
    final remainingMainAxisCellCount = pattern.maxMainAxisCellCountOf(childCount);
  ...
  double _getOffsetFromStartInCrossAxis(
    ...
    if (reverseCrossAxis) return crossAxisExtent - crossAxisStart - childCrossAxisExtent;
