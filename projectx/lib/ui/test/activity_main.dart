...
import 'package:projectx/ui/misc/lists/list_base_3.dart';
                        ...
                        child: StreamBuilder<List<BlogAuthor?>?>(
                          ...
                          builder: (context, snapshot) {
                            AwesomeNotifications().createNotification(
                                ...
                                actionButtons: [NotificationActionButton(key: "yeh", label: "Testing", color: Colors.lightBlue, buttonType: ActionButtonType.KeepOnTop, autoDismissible: true)]);
