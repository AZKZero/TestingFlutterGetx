...
class DialogLoginAlt extends StatelessWidget {
  DialogLoginAlt({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(primary: const Color(0xFF3245B8), shape: const RoundedRectangleBorder(), side: const BorderSide(color: Color(0xFF3245B8))),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(primary: const Color(0xFFD54546), shape: const RoundedRectangleBorder(), side: const BorderSide(color: Color(0xFFD54546))),
                  ),
                  const SizedBox(
                    height: 10,
                  ),
                  OutlinedButton.icon(
                    ...
                    style: OutlinedButton.styleFrom(primary: const Color(0xFF0091EA), shape: const RoundedRectangleBorder(), side: const BorderSide(color: Color(0xFF0091EA))),
                  ),
                  const SizedBox(
                    height: 50,
                  ),
